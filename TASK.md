...
Creating Backend Rest API for [To Do list task](https://github.com/listguy/pre-course-2021-final-boilerplate)
...
Create Restful API using NodeJS + ExpressJS for to do list app with 5 entry points:

-   a GET request to /tasks/ returns a list of tasks objects

-   a GET request to /tasks/{id} returns the details of task 123

-   a POST request to /tasks create new task object and return the new task object (should include unique id)

-   a PUT request to /tasks/{id} get in the body params updated task object and return the updated task

-   a DELETE request to /tasks/{id} delete a task

Have a file called tasks.json that will include an array of all tasks. save all your changes into this file.
...
- Submit your solution repo to the classroom system
